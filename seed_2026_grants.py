...
from agents.grant_scraper.grant_database import GrantDatabase
...
def seed_2026_grants():
    ...
    for grant_data in grants_2026:
        try:
            ...
            existing = next((g for g in existing_grants if g.get('identifier') == grant_data['identifier']), None)
                ...
                if grant_data.get('deadline'):
                    try:
                        ...
                        if len(deadline_parts) >= 3:
                            ...
                            db.add_milestone(grant_id, 'Application Deadline', deadline_iso, 
    ...
    print(f"\n   Generate dashboard to view: python -m agents.grant_scraper.cli dashboard")
