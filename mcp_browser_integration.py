...
class MCPBrowserIntegration:
        ...
        try:
            ...
            try:
                with open('/Users/russellpowers/Grants/.cursor/debug.log', 'a') as f:
                    f.write(json.dumps({"sessionId":"debug-session","runId":"post-fix-v2","hypothesisId":"H2","location":"mcp_browser_integration.py:initialize_browser:entry","message":"initialize_browser called","data":{"mcp_tools_keys":list(mcp_tools.keys()) if mcp_tools else None},"timestamp":int(__import__('time').time()*1000)}) + '\n')
            ...
            playwright_tools = ['playwright_navigate', 'playwright_fill', 'playwright_click', 'browser_navigate', 'browser_type', 'browser_click']
            ...
            if has_playwright:
                ...
                try:
                    with open('/Users/russellpowers/Grants/.cursor/debug.log', 'a') as f:
                        f.write(json.dumps({"sessionId":"debug-session","runId":"post-fix-v2","hypothesisId":"H2","location":"mcp_browser_integration.py:initialize_browser:playwright","message":"Playwright tools detected, no session needed","data":{},"timestamp":int(__import__('time').time()*1000)}) + '\n')
                except Exception as e:
                    pass
                # #endregion
            ...
            try:
                with open('/Users/russellpowers/Grants/.cursor/debug.log', 'a') as f:
                    f.write(json.dumps({"sessionId":"debug-session","runId":"post-fix-v2","hypothesisId":"H2","location":"mcp_browser_integration.py:initialize_browser:no_tools","message":"No MCP browser tools available","data":{},"timestamp":int(__import__('time').time()*1000)}) + '\n')
            except Exception as e:
                pass
            # #endregion
            ...
            try:
                with open('/Users/russellpowers/Grants/.cursor/debug.log', 'a') as f:
                    f.write(json.dumps({"sessionId":"debug-session","runId":"post-fix-v2","hypothesisId":"H2","location":"mcp_browser_integration.py:initialize_browser:error","message":"Error initializing browser","data":{"error":str(e)},"timestamp":int(__import__('time').time()*1000)}) + '\n')
            except Exception as e:
                pass
            # #endregion
    ...
    def navigate(self, url: str) -> bool:
        ...
        try:
            ...
            import json
            with open('/Users/russellpowers/Grants/.cursor/debug.log', 'a') as f:
                f.write(json.dumps({"sessionId":"debug-session","runId":"initial","hypothesisId":"H3","location":"mcp_browser_integration.py:navigate:entry","message":"Navigate called","data":{"url":url,"mcp_tools_keys":list(self.mcp_tools.keys()) if self.mcp_tools else None},"timestamp":int(__import__('time').time()*1000)}) + '\n')
            # #endregion
            
            navigate_tool = None
            
            # Try Playwright tools first (direct integration)
            playwright_navigate = self.mcp_tools.get('playwright_navigate') or self.mcp_tools.get('browser_navigate') if self.mcp_tools else None
            if playwright_navigate:
                try:
                    # #region agent log
                    with open('/Users/russellpowers/Grants/.cursor/debug.log', 'a') as f:
                        f.write(json.dumps({"sessionId":"debug-session","runId":"initial","hypothesisId":"H3","location":"mcp_browser_integration.py:navigate:playwright","message":"Using Playwright navigate","data":{"url":url},"timestamp":int(__import__('time').time()*1000)}) + '\n')
                    # #endregion
                    ...
                    if result:
                        ...
                        # #region agent log
                        playwright_get_url = self.mcp_tools.get('playwright_get_url') or self.mcp_tools.get('browser_get_url') if self.mcp_tools else None
                        actual_url = playwright_get_url() if playwright_get_url else url
                        with open('/Users/russellpowers/Grants/.cursor/debug.log', 'a') as f:
                            f.write(json.dumps({"sessionId":"debug-session","runId":"initial","hypothesisId":"H3","location":"mcp_browser_integration.py:navigate:playwright_success","message":"Playwright navigate succeeded","data":{"url":url,"actual_url":actual_url},"timestamp":int(__import__('time').time()*1000)}) + '\n')
                        # #endregion
                    ...
                    # #region agent log
                    with open('/Users/russellpowers/Grants/.cursor/debug.log', 'a') as f:
                        f.write(json.dumps({"sessionId":"debug-session","runId":"initial","hypothesisId":"H3","location":"mcp_browser_integration.py:navigate:playwright_error","message":"Playwright navigate failed","data":{"error":str(e)},"timestamp":int(__import__('time').time()*1000)}) + '\n')
                    # #endregion
    ...
    def take_snapshot(self) -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            playwright_snapshot = self.mcp_tools.get('playwright_snapshot') or self.mcp_tools.get('browser_take_snapshot')
    ...
    def find_element(self, description: str, return_action: bool = False) -> Optional[Dict[str, Any]]:
        """
        ...
        try:
            ...
            import json
            with open('/Users/russellpowers/Grants/.cursor/debug.log', 'a') as f:
                f.write(json.dumps({"sessionId":"debug-session","runId":"initial","hypothesisId":"H1,H2,H4","location":"mcp_browser_integration.py:find_element:entry","message":"find_element called","data":{"description":description,"mcp_tools_keys":list(self.mcp_tools.keys()) if self.mcp_tools else None,"has_playwright":bool(self.mcp_tools.get('playwright_navigate') if self.mcp_tools else False)},"timestamp":int(__import__('time').time()*1000)}) + '\n')
            # #endregion
            ...
            if has_playwright:
                # #region agent log
                with open('/Users/russellpowers/Grants/.cursor/debug.log', 'a') as f:
                    f.write(json.dumps({"sessionId":"debug-session","runId":"initial","hypothesisId":"H1","location":"mcp_browser_integration.py:find_element:playwright","message":"Playwright tools available, returning placeholder","data":{"description":description},"timestamp":int(__import__('time').time()*1000)}) + '\n')
                # #endregion
                ...
                return {'description': description, 'found': True, 'method': 'playwright', 'selector': description}
            
            observe_tool = None
            if self.use_multi_session and self.session_id:
                observe_tool = self.mcp_tools.get('multi_browserbase_stagehand_observe_session') if self.mcp_tools else None
            else:
                observe_tool = self.mcp_tools.get('browserbase_stagehand_observe') if self.mcp_tools else None
            
            # #region agent log
            with open('/Users/russellpowers/Grants/.cursor/debug.log', 'a') as f:
                f.write(json.dumps({"sessionId":"debug-session","runId":"initial","hypothesisId":"H2","location":"mcp_browser_integration.py:find_element:observe_check","message":"Checking observe tool","data":{"has_observe_tool":bool(observe_tool)},"timestamp":int(__import__('time').time()*1000)}) + '\n')
            # #endregion
            ...
            if observe_tool:
                ...
                # #region agent log
                with open('/Users/russellpowers/Grants/.cursor/debug.log', 'a') as f:
                    f.write(json.dumps({"sessionId":"debug-session","runId":"initial","hypothesisId":"H2","location":"mcp_browser_integration.py:find_element:observe_result","message":"Observe tool result","data":{"has_result":bool(result)},"timestamp":int(__import__('time').time()*1000)}) + '\n')
                # #endregion
                return result
            else:
                # #region agent log
                with open('/Users/russellpowers/Grants/.cursor/debug.log', 'a') as f:
                    f.write(json.dumps({"sessionId":"debug-session","runId":"initial","hypothesisId":"H1,H2","location":"mcp_browser_integration.py:find_element:no_tool","message":"No observe tool available","data":{"description":description},"timestamp":int(__import__('time').time()*1000)}) + '\n')
                # #endregion
                logger.warning("Observe tool not available")
                return None
            ...
            # #region agent log
            with open('/Users/russellpowers/Grants/.cursor/debug.log', 'a') as f:
                f.write(json.dumps({"sessionId":"debug-session","runId":"initial","hypothesisId":"H1,H2,H4","location":"mcp_browser_integration.py:find_element:error","message":"Error finding element","data":{"error":str(e)},"timestamp":int(__import__('time').time()*1000)}) + '\n')
            # #endregion
    ...
    def click(self, element_description: str, element_ref: Optional[str] = None) -> bool:
        ...
        try:
            ...
            playwright_click = self.mcp_tools.get('playwright_click') or self.mcp_tools.get('browser_click')
            if playwright_click:
                try:
    ...
    def type_text(self, element_description: str, text: str, element_ref: Optional[str] = None, 
        ...
        try:
            ...
            try:
                ...
                with open('/Users/russellpowers/Grants/.cursor/debug.log', 'a') as f:
                    f.write(json.dumps({"sessionId":"debug-session","runId":"post-fix-v3","hypothesisId":"H5","location":"mcp_browser_integration.py:type_text:entry","message":"type_text called","data":{"element_description":element_description,"has_element_ref":bool(element_ref),"has_mcp_tools_attr":hasattr(self, 'mcp_tools'),"mcp_tools_keys":mcp_keys},"timestamp":int(time_module.time()*1000)}) + '\n')
            ...
            try:
                with open('/Users/russellpowers/Grants/.cursor/debug.log', 'a') as f:
                    f.write(json.dumps({"sessionId":"debug-session","runId":"post-fix-v2","hypothesisId":"H5","location":"mcp_browser_integration.py:type_text:playwright_check","message":"Checking Playwright tools","data":{"has_mcp_tools":bool(self.mcp_tools),"mcp_tools_keys":list(self.mcp_tools.keys()) if self.mcp_tools else None,"has_playwright_fill":bool(playwright_fill),"has_playwright_type":bool(playwright_type)},"timestamp":int(__import__('time').time()*1000)}) + '\n')
            except Exception as log_err:
            ...
            if playwright_fill or playwright_type:
                try:
                    ...
                    try:
                        with open('/Users/russellpowers/Grants/.cursor/debug.log', 'a') as f:
                            f.write(json.dumps({"sessionId":"debug-session","runId":"post-fix-v2","hypothesisId":"H5","location":"mcp_browser_integration.py:type_text:playwright","message":"Using Playwright fill","data":{"element_description":element_description,"has_fill":bool(playwright_fill),"has_type":bool(playwright_type)},"timestamp":int(__import__('time').time()*1000)}) + '\n')
                    except Exception as log_err:
                        pass
                    # #endregion
                    ...
                    if playwright_type:
                        ...
                        result = playwright_type(desc=element_description, txt=text, elem_ref=element_ref)
                    ...
                    if result:
                        ...
                        try:
                            with open('/Users/russellpowers/Grants/.cursor/debug.log', 'a') as f:
                                f.write(json.dumps({"sessionId":"debug-session","runId":"post-fix-v2","hypothesisId":"H5","location":"mcp_browser_integration.py:type_text:playwright_success","message":"Playwright fill succeeded","data":{"element_description":element_description},"timestamp":int(__import__('time').time()*1000)}) + '\n')
                        except Exception as log_err:
                            pass
                        # #endregion
                        ...
                        try:
                            with open('/Users/russellpowers/Grants/.cursor/debug.log', 'a') as f:
                                f.write(json.dumps({"sessionId":"debug-session","runId":"post-fix-v2","hypothesisId":"H5","location":"mcp_browser_integration.py:type_text:playwright_failed","message":"Playwright fill returned False","data":{"element_description":element_description},"timestamp":int(__import__('time').time()*1000)}) + '\n')
                        except Exception as log_err:
                            pass
                        # #endregion
                except Exception as e:
                    ...
                    try:
                        with open('/Users/russellpowers/Grants/.cursor/debug.log', 'a') as f:
                            f.write(json.dumps({"sessionId":"debug-session","runId":"post-fix-v2","hypothesisId":"H5","location":"mcp_browser_integration.py:type_text:playwright_error","message":"Playwright type failed with exception","data":{"error":str(e),"error_type":type(e).__name__},"timestamp":int(__import__('time').time()*1000)}) + '\n')
                    except Exception as log_err:
                        pass
                    # #endregion
            ...
            if not element_ref:
                ...
                if type_tool:
                    type_tool(element=element_description, ref=element_ref, text=text, submit=submit)
                    time.sleep(0.5)
                    logger.info(f"Typed text into: {element_description}")
                    return True
    ...
    def select_option(self, element_description: str, values: List[str], 
                     element_ref: Optional[str] = None) -> bool:
        """
    ...
    def take_screenshot(self, name: str) -> Optional[str]:
        ...
        try:
            ...
            playwright_screenshot = self.mcp_tools.get('playwright_screenshot') or self.mcp_tools.get('browser_take_screenshot')
    ...
    def get_current_url(self) -> Optional[str]:
        ...
        try:
            ...
            playwright_get_url = self.mcp_tools.get('playwright_get_url') or self.mcp_tools.get('browser_get_url')
    ...
    def wait_for(self, text: Optional[str] = None, text_gone: Optional[str] = None, 
        ...
        try:
            ...
            playwright_wait = self.mcp_tools.get('playwright_wait') or self.mcp_tools.get('browser_wait')
            if playwright_wait:
                try:
                    if time_seconds:
    ...
    def close_browser(self):
        ...
        try:
            ...
            playwright_close = self.mcp_tools.get('playwright_close') or self.mcp_tools.get('browser_close')
            if playwright_close:
                try:
                    playwright_close()
