...
class DataExtractor:
    ...
    def identify_relevant_documents(
        self, grant_name: str, organization_name: Optional[str] = None
    ) -> List[str]:
        """
        ...
        for md_file in markdown_files:
            ...
            try:
                ...
                if organization_name:
                    ...
                    if (
                        organization_name.lower() not in org_name.lower()
                        and org_name.lower() not in organization_name.lower()
                    ):
                        continue
    ...
    def extract_grant_data(
        self, grant_name: str, document_paths: Optional[List[str]] = None
    ) -> Dict[str, Any]:
        """
    ...
    def get_standardized_data(self, grant_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        standardized = {
            ...
            "technical_requirements": "\n".join(
                grant_data.get("technical", {}).get("requirements", [])
            ),
        }
