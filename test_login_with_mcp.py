...
def test_login_with_available_tools():
    ...
    try:
        from agents.grant_scraper.mcp_browser_integration import MCPBrowserIntegration
        ...
        from agents.grant_scraper.mcp_tools_helper import create_mcp_tools_dict_from_globals
