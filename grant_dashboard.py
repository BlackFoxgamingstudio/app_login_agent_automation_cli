...
class GrantDashboard:
    ...
    def generate_dashboard(self) -> str:
        ...
        html = self._generate_html(planned, in_progress, submitted, completed, grants_by_month, all_grants)
    ...
    def _generate_html(self, planned: List[Dict], in_progress: List[Dict],
                      submitted: List[Dict], completed: List[Dict],
                      grants_by_month: Dict[str, Any], all_grants: List[Dict]) -> str:
...
<body>
    ...
    def _generate_timeline_view(self, grants_by_month: Dict[str, Any]) -> str:
        ...
        for month_key in sorted(grants_by_month.keys()):
            ...
            month_class = 'month-past' if is_past else 'month-current' if is_current else 'month-upcoming'
    ...
    def _generate_status_view(self, planned: List[Dict], in_progress: List[Dict],
                             submitted: List[Dict], completed: List[Dict]) -> str:
    ...
    def _generate_priority_view(self, all_grants: List[Dict]) -> str:
        ...
        sorted_grants = sorted(all_grants, key=lambda x: (
            -x.get('priority', 5),
            x.get('deadline_timestamp') or float('inf')
        ))
            ...
            <div class="doc-section">
                ...
                <div class="step-card">
                    ...
                    <div class="step-content">
                        ...
                        <pre><code>python -m agents.grant_scraper.cli extract \\
  ...
  --output extracted_data.json</code></pre>
                        ...
                        <pre><code>python -m agents.grant_scraper.cli validate \\
  --grant-name "Moving Stories: Short-Form Graphic Novels..." \\
  --config agents/grant_scraper/grant_config.yaml</code></pre>
                    </div>
                </div>
                ...
                <div class="step-card">
                    ...
                    <div class="step-content">
                        ...
                        <pre><code>python -m agents.grant_scraper.cli automate \\
  --grant-name "Moving Stories: Short-Form Graphic Novels..." \\
...
python -m agents.grant_scraper.cli automate \\
  ...
  --openai-api-key 'your-key'</code></pre>
                    ...
                    <pre><code>python -m agents.grant_scraper.cli dashboard</code></pre>
                </div>
            </div>
    ...
    def _generate_grant_card(self, grant: Dict[str, Any], show_deadline: bool = False,
                            show_progress: bool = False, show_priority: bool = False) -> str:
        ...
        if grant.get('deadline_timestamp'):
            try:
                ...
                if days_until < 0:
                    deadline_display += f' <span class="deadline-overdue">({abs(days_until)} days overdue)</span>'
                elif days_until <= 7:
                    deadline_display += f' <span class="deadline-urgent">({days_until} days remaining)</span>'
                elif days_until <= 30:
                    deadline_display += f' <span class="deadline-warning">({days_until} days remaining)</span>'
                else:
                    deadline_display += f' <span class="deadline-ok">({days_until} days remaining)</span>'
            except:
                pass
        ...
        deadline_attr = f'data-deadline="{grant.get("deadline", "")}"' if grant.get('deadline') else ''
            ...
            <div id="doc-api" class="doc-section">
                ...
                <div class="api-class">
                    ...
                    <div class="api-method">
                        <h4>__init__(username, password, docs_folder, config_path=None, use_narratives=False, openai_api_key=None, narrative_model=None, mcp_tools=None, db_path="agents/grant_scraper/grants.db")</h4>
                ...
                <div class="api-class">
                    ...
                    <div class="api-method">
                        <h4>__init__(db_path="agents/grant_scraper/grants.db")</h4>
            ...
            <div id="doc-integration" class="doc-section">
                ...
                <div class="doc-subsection">
                    ...
                    <div class="code-block">
                        ...
                        <pre><code>from agents.grant_scraper import MCPBrowserIntegration
...
browser.initialize_browser(mcp_tools)</code></pre>
                ...
                <div class="doc-subsection">
                    ...
                    <div class="code-block">
                        <h4>Usage:</h4>
                        <pre><code>from agents.grant_scraper import NarrativeGenerator
...
narrative = generator.generate_project_description(grant_name, grant_data)</code></pre>
                ...
                <div class="doc-subsection">
                    ...
                    <div class="code-block">
                        <h4>Basic Usage:</h4>
                        <pre><code>from agents.grant_scraper import GrantDatabase
